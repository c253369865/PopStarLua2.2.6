...
function VisibleRect:getWinWidth()
	self:lazyInit()
	return self.s_visibleRect.size.width
end

function VisibleRect:getWinHeight()
	self:lazyInit()
	return self.s_visibleRect.size.height
end

function VisibleRect:getWinSize()
	self:lazyInit()
	return CCSizeMake( self.s_visibleRect.size.width, self.s_visibleRect.size.height )
end
